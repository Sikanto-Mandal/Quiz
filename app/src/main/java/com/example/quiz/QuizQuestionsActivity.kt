            ...
            R.id.btnSubmit -> {
                if(mSelectedOptionPostion == 0){
                    ...
                    if(question!!.correctAnswer != mSelectedOptionPostion){
                        answerView(mSelectedOptionPostion,R.drawable.wrong_answer_option_border_bg)
                    } else {
                        mCurrectAnswer ++
                    }

                    answerView(question.correctAnswer,R.drawable.correct_answer_option_border_bg)
